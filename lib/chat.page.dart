...
class _ChatBotPageState extends State<ChatBotPage> {
  ...
  Future<http.Response> fetchChatResponse(Uri uri, Map<String, String> headers, Map<String, dynamic> prompt, {int retries = 3}) async {
    int attempt = 0;
    while (attempt < retries) {
      var response = await http.post(uri, headers: headers, body: json.encode(prompt));
                ...
                IconButton(
                  onPressed: () async {
                    ...
                    Map<String, String> headers = {
                      ...
                      "Authorization": "Bearer sk-proj-jB3x2yUzIshqlu51LpPgT3BlbkFJUEnJEcwudQfPIWojcJBh"
                    };
                    var prompt = {
                      "model": "gpt-3.5-turbo",
                      "messages": [
                    ...
                    try {
                      var resp = await fetchChatResponse(openAiLLMUri, headers, prompt);
                      ...
                      if (resp.statusCode == 200) {
                        ...
                        if (llmResponse['choices'] != null &&
                            ...
                            llmResponse['choices'][0]['message']['content'] != null) {
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            title: Text("Error"),
                            content: Text("Failed to fetch response after multiple attempts. Please try again later."),
                            actions: [
                              TextButton(
                                child: Text("OK"),
                                onPressed: () {
